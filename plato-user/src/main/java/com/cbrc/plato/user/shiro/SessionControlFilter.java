...
//            log.info("kickout ---- sessionId:{} Attribute = {}",sessionId.toString(),session.getAttribute("kickout"));
        //读取缓存   没有就存入
        ...
        if(deque == null){
//            log.info("kickout ----  没有session队列,没有登录过");
        ...
        if(!deque.contains(sessionId) && session.getAttribute("kickout") == null) {
            ...
            //将用户的sessionId队列缓存
//            log.info("kickout ----  将sessionId存入缓存");
